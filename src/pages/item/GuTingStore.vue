<template>
  <div>
    ...
    <div v-if="getOtherStores().length > 0" class="category-section">
      <q-separator />
      <div class="category-header q-pa-md">
        <q-icon name="checkroom" size="md" class="q-mr-sm" />
        <span class="category-title text-h6 text-weight-bold">服飾類</span>
      </div>
      <q-expansion-item
...
<script lang="ts">
import { stores, getStoresByCategory, getOtherStores, goToMap } from './ts/GuTingStore';

      ...
      stores: [
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=懿品小珍+台北市中正區寧波西街88之1號',
        },
        {
          name: '八方雲集（中正南海店）',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=昇客雞肉+台北市中正區寧波西街88號',
        },
        {
          name: '建中側門抓餅',
          address: '台北市中正區泉州街9號',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=建中側門抓餅+台北市中正區泉州街9號',
        },
        {
          name: '搭伙',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=金仙快餐便當+台北市中正區寧波西街74號',
        },
        {
          name: '養鍋 中正店',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=三商巧福+台北市中正區南昌路一段46號',
        },
        {
          name: '老建中麵店',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=老建中麵店+台北市中正區泉州街39號',
        },
        {
          name: '南海19(建豆)',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=建豆+台北市中正區寧波西街124-2號',
        },
        {
          name: '老熊牛肉麵',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=老熊牛肉麵+台北市中正區南海路38-2號',
        },
        {
          name: '吉仕達義麵房 南昌店',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=麵老大+台北市中正區寧波西街85-1號',
        },
        {
          name: '福井麵疙瘩',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=福井麵疙瘩+台北市中正區寧波西街87-3號',
        },
        {
          name: '瑞哥雞肉飯 南海店',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=瑞哥雞肉飯+台北市中正區南海路34號',
        },
        {
          name: 'EBISU KITCHEN',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=建中黑砂糖刨冰+台北市中正區泉州街35號',
        },
        {
          name: '星巴克 南海門市',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=CoCo都可+台北市中正區寧波西街83-2號',
        },
        {
          name: 'QBurger 中正寧波店',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=QBurger+台北市中正區寧波西街100號',
        },
        {
          name: '十平方圖書文具館—南海店',
        ...
        },
        {
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=鼎紘影印+台北市中正區寧波西街83號',
        },
        {
          name: '動翅音樂',
          ...
          discount: 'unknown',
          mapUrl:
            'https://www.google.com/maps/search/?api=1&query=動翅音樂+台北市中正區金華街19-1號',
        },
      ],
    };
  },
